...
const Freegame = () => {
  const games = data.game.slice(0, 2); // Giới hạn số lượng trò chơi thành 4 trò chơi
  ...
  return (
    <div className='freegames'>
      ...
      <div className='flex'>
        {games.map((game) => (
          <a key={game.game_id} href={`https://www.epicgames.com/store/en-US${game.url}`} className='game freenow'>
            <div className='gameimg'>
              <img src={game.images[0].url} alt="game" />
            </div>
